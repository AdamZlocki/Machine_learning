...
# FIXME: Create a linear SVC classifier (with C = 0.1). - DONE
clf = svm.LinearSVC(C=0.1)

# FIXME: Fit the SVC model using the training data. - DONE
clf.fit(X_train, y_train)

# FIXME: Predict the labelling. - DONE
y_pred = clf.predict(X_train)

# FIXME: Compute the training accuracy. - DONE
acc_train = accuracy_score(y_train, y_pred)
print(f'Training Accuracy: {round(acc_train * 100, 2)}%\n')

# %% =================== Part 4: Test Spam Classification ================
#  After training the classifier, we can evaluate it on a test set.

# FIXME: Load the test dataset ('data/spamTest_X.csv', 'data/spamTest_y.csv'). - DONE
...
print(f'Test Accuracy: {round(acc_test * 100, 2)}%\n')
...
# FIXME: Print the list of 15 most prominent features. - DONE
...
for i in range(15):
    # FIXME: Replace each `None` with an appropriate expression. - DONE
