...
def process_email(email_contents: str) -> List[int]:
    ...
    # FIXME: Load the vocabulary. - DONE
    vocabulary_dict = get_vocabulary_dict()

    # FIXME: Initialize the return value. - DONE
    word_indices = []
    ...
    # FIXME: Convert email content to lower case. - DONE
    ...
    # ========= Making single string from processed email - own idea =================
    # tokens = [token for token in tokens if not len(token) < 1]
    # tokens = ' '.join(tokens)
    # print(tokens)
    # Print footer
    print('\n\n=========================\n')
